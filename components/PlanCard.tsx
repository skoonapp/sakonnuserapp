      ...
      <div className="w-full grid grid-cols-2 gap-2 divide-x divide-slate-200 dark:divide-slate-800">
        ...
        <div className="flex flex-col items-center px-1.5">
            ...
            <button
              ...
              className="w-full mt-auto bg-cyan-600 hover:bg-cyan-700 dark:bg-cyan-500 dark:hover:bg-cyan-400 text-white font-bold py-1.5 text-sm rounded-lg transition-colors shadow-md disabled:bg-slate-400 disabled:cursor-not-allowed"
            >
        ...
        <div className="flex flex-col items-center px-1.5">
            ...
            <button
              ...
              disabled={isAnyPlanLoading}
              className="w-full mt-auto bg-teal-500 hover:bg-teal-600 text-white font-bold py-1.5 text-sm rounded-lg transition-colors shadow-md disabled:bg-slate-400 disabled:cursor-not-allowed"
            >
