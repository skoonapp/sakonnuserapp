      ...
      >
        ...
        <div className="p-6 md:p-8 space-y-4 text-slate-700 dark:text-slate-300 leading-relaxed">
            ...
            <div>
              ...
              <p>किसी भी भुगतान-संबंधी समस्या के लिए, कृपया हमें अपनी लेनदेन आईडी और समस्या के विवरण के साथ <a href="mailto:appsakoon@gmail.com" className="text-cyan-600 dark:text-cyan-400 hover:underline">appsakoon@gmail.com</a> पर ईमेल करें।</p>
            </div>
